				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td valign="middle"  style="padding-bottom: 2em;">
								<input type="text" name="user"  value="" placeholder="Required" maxlength="25"  required>
						...
						<tr>
							...
							<td valign="middle"  style="padding-bottom: 2em;">
								<input type="password" name="pass1"  value="" placeholder="Required" maxlength="30"  required>
						...
						<tr>
							...
							<td valign="middle"  style="padding-bottom: 2em;">
								<input  type="password" name="pass2"  value="" placeholder="Required" maxlength="30"  required>
							</td>
														<td>
							</td>	
						</tr>
						<tr>
							...
							<td valign="middle"  style="padding-bottom: 2em;">
								<input type="text" name="email"  value="" placeholder="Optional (recommended)"  maxlength="30" >
							</td>
														<td>
							</td>	
						</tr>
